/**
 * Document fonts and typography for the LaTeX / ChatGPT to PDF preview. Kept apart
 * from MathDocument (KaTeX + Markdown, ~500 KB) so pages can render and hydrate
 * without waiting for the maths renderer.
 */
