...
| Layer | File | Role |
|:------|:-----|:-----|
| 🌐 **Route** | [App.tsx](file:///d:/ziptrip/projects/nkc-test/frontend/src/App.tsx#L67-L70) | Registers `/generate-with-ai` route → [AIImportRoute](file:///d:/ziptrip/projects/nkc-test/frontend/src/App.tsx#67-71) |
...
**What happens:** [App.tsx](file:///d:/ziptrip/projects/nkc-test/frontend/src/App.tsx) line 67–70 creates the [AIImportRoute](file:///d:/ziptrip/projects/nkc-test/frontend/src/App.tsx#67-71) component. When user navigates to `/generate-with-ai`, it renders [AITestImporter](file:///d:/ziptrip/projects/nkc-test/frontend/src/pages/AITestImporter.tsx#110-1439) with an `onImport` callback that navigates to `/create-test` with the extracted data.
...
**Files involved:** [AITestImporter.tsx](file:///d:/ziptrip/projects/nkc-test/frontend/src/pages/AITestImporter.tsx) lines 161–239
...
**Files involved:**
- Frontend: [AITestImporter.tsx](file:///d:/ziptrip/projects/nkc-test/frontend/src/pages/AITestImporter.tsx) [handleStreamProcess](file:///d:/ziptrip/projects/nkc-test/frontend/src/pages/AITestImporter.tsx#L369-L473) — line 369
- Backend: [ai.py](file:///d:/ziptrip/projects/nkc-test/backend/app/routers/ai.py) [parse_document_stream](file:///d:/ziptrip/projects/nkc-test/backend/app/routers/ai.py#L386-L560) — line 386
...
This is where the magic happens. Here's the inside of [process_files_stream()](file:///d:/ziptrip/projects/nkc-test/backend/ai_preview_importer/pdf_vision_pipeline.py#1094-1422):
...
**File:** [pdf_vision_pipeline.py](file:///d:/ziptrip/projects/nkc-test/backend/ai_preview_importer/pdf_vision_pipeline.py) [process_files_stream](file:///d:/ziptrip/projects/nkc-test/backend/ai_preview_importer/pdf_vision_pipeline.py#L1094-L1421) — line 1094
...
**The only place Tesseract OCR appears:** Line 34–40 of [pdf_vision_pipeline.py](file:///d:/ziptrip/projects/nkc-test/backend/ai_preview_importer/pdf_vision_pipeline.py) — it's imported as **optional** but never used in the main pipeline. The entire OCR is done by Gemini Vision.

**The only place OpenCV is used:** [quality_analyzer.py](file:///d:/ziptrip/projects/nkc-test/backend/ai_preview_importer/quality_analyzer.py) — to check image quality (sharpness, contrast, noise, brightness) and decide the DPI for rendering.
